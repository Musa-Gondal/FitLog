 ...
 * setType: "N" normal, "W" warm-up, "D" drop set, "F" to failure.
...
val WorkoutSet.isWorking: Boolean get() = setType != "W"

/** Free-text note attached to one exercise within one workout. */
@Entity(tableName = "exercise_notes", indices = [Index("workoutId")])
